...
curl -L https://raw.githubusercontent.com/aarron-lee/decky-loader/main/dist/plugin_loader-prerelease.service  --output ${HOMEBREW_FOLDER}/services/plugin_loader-prerelease.service
